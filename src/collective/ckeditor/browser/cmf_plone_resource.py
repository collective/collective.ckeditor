# copy of Products.CMFPlone.resources.browser.resource.py
# CMFPlone 6.1.3
# commit hash fc5ae6f6c385fbee39b9fce5db8c40e66481815b
...
class ResourceBase:
    ...
    def update(self):
        ...
        # added
        self.resolver_css = resolver_css
        # end of added code
        try:
